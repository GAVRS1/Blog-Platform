      ...
      <div className="card-body p-6">
        ...
        >
          <div className="flex items-center gap-4">
            <LikeButton 
              postId={post.id} 
              initialLiked={post.isLikedByCurrentUser || false} // Используем правильное поле
              initialCount={post.likeCount || 0}               // Используем правильное поле
            />
            <Link 
            ...
            >
              ...
              <span className="text-sm font-medium">{post.commentCount || 0}</span> {/* Используем правильное поле */}
            </Link>
          </div>
