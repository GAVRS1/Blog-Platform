        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemporaryKey = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerifications_TemporaryKey",
                table: "EmailVerifications",
                column: "TemporaryKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Follows_FollowerUserId_TargetUserId",
                table: "Follows",
                columns: new[] { "FollowerUserId", "TargetUserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RecipientId_SenderId_IsRead",
                table: "Messages",
                columns: new[] { "RecipientId", "SenderId", "IsRead" });
