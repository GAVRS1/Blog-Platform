...
public class FileService : IFileService
{
    ...
    public FileService(string baseStoragePath = null)
    {
        ...
        _baseStoragePath = baseStoragePath ?? @"C:\Users\begin\source\repos\SaveContentPlatform"; //Изменить перед запуском

        // Пути к папкам по типам
    ...
    private Size CalculateAspectRatioSize(Size originalSize, Size targetSize)
    {
